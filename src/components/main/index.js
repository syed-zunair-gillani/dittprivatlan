  ...
  return (
    <main className="relative flex items-center justify-center h-screen overflow-hidden">
      <div class="relative z-30 p-5 text-2xl bg-black/60 w-full h-full">
        <div className='text-4xl sm:text-5xl md:text-6xl flex flex-col justify-center items-center h-full lg:text-8xl font-bold text-main max-w-[1100px] mx-auto text-center '>
